...
func TestProcedureMappingCoversPrivilegedServices(t *testing.T) {
	want := []string{
		...
		authz.ProcJudgeReviewHandicap,
		authz.ProcJudgeRefundSelection,
		authz.ProcJudgeLockHandicap,
		authz.ProcJudgeSetStreamUrl,
		authz.ProcJudgeReviewSetup,
		authz.ProcJudgeConfirmSetup,
		authz.ProcJudgeStartRound,
		authz.ProcJudgeFinishRound,
		authz.ProcJudgeReportResult,
		authz.ProcJudgeRecordViolation,
		authz.ProcJudgeListViolations,
