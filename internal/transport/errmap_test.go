...
func TestToConnectError(t *testing.T) {
	cases := []struct {
		...
		{betting.ErrDuplicateMatchInParlay, connect.CodeInvalidArgument},
		{betting.ErrMarketNotFound, connect.CodeNotFound},
		{betting.ErrMarketClosed, connect.CodeFailedPrecondition},
		{betting.ErrOutcomeInvalid, connect.CodeInvalidArgument},
		{betting.ErrMarketsExist, connect.CodeAlreadyExists},
		{betting.ErrMarketSettled, connect.CodeFailedPrecondition},
		{betting.ErrRoundNotFinished, connect.CodeFailedPrecondition},
		...
		{match.ErrSetupNotConfirmed, connect.CodeFailedPrecondition},
		{match.ErrSetupAlreadyConfirmed, connect.CodeAlreadyExists},
		{match.ErrMatchDecided, connect.CodeFailedPrecondition},
		{match.ErrRoundInProgress, connect.CodeFailedPrecondition},
		{match.ErrRoundNotFound, connect.CodeNotFound},
		{match.ErrRoundAlreadyFinished, connect.CodeFailedPrecondition},
		{match.ErrRoundsInconsistent, connect.CodeInternal},
		{match.ErrMultiRoundMatch, connect.CodeFailedPrecondition},
		{match.ErrPlayerNotInMatch, connect.CodeInvalidArgument},
		{match.ErrInvalidRuling, connect.CodeInvalidArgument},
		{handicap.ErrInvalidItemParams, connect.CodeInternal},
		{handicap.ErrDrawPoolEmpty, connect.CodeFailedPrecondition},
		{handicap.ErrAlreadyDrawn, connect.CodeInternal},
		{handicap.ErrCatalogueInUse, connect.CodeFailedPrecondition},
		{handicap.ErrCatalogueMismatch, connect.CodeFailedPrecondition},
